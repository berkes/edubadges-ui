...
I18n.translations.en = {
  ...
  badgeAward: {
    ...
    bulkAward: {
      ...
      wrong:
        "Your upload contains {{count}} invalid entries which are removed from the upload.",
      duplicate:
        "Your upload contains {{count}} duplicate entries which are removed from the upload.",
      eppnExisting:
